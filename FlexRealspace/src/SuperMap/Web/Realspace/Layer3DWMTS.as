package SuperMap.Web.Realspace
{
	 ...
	 * （可以初始化，对外开放）
	 */
	public class Layer3DWMTS extends ClassBase
	{
		/**
		 * 用于确认对象的类型
		 */
		public var CLASSNAME:String="Layer3DWMTS";
		/**
		 * 对应js API的类全名
		 */
		private var REALSPACE_CLASSNAME:String="SuperMap.Web.Realspace.Layer3DWMTS";
		/**
		 * WMTS图层的构造函数
		 * @example 以下例子示范了如何使用
		 * <listing>
		 ...
		 * </listing>
		 */
		public function Layer3DWMTS(strServerRootUrl:Object=null, strLayerName:String=null)
		{
			var key:Number;
			var isNew:Boolean;
			var array:Object;
		...
		/**
		 * 获取添加到三维场景中的WMTS图层的背景是否透明。 
		 * @return 返回添加到三维场景中的WMTS图层的背景是否透明。
		 */
		...
		/**
		 * 设置添加到三维场景中的WMTS图层的背景是否透明。 
		 * @param value 需要设置的添加到三维场景中的WMTS图层的背景是否透明。
		 */
